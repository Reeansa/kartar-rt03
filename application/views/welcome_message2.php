...
<html lang="en">
    ...
    <body id="page-top">
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card py-4 h-100">
                            <div class="card-body text-center">
                                ...
                                <hr class="my-4" />
                                <div class="small text-black-50"><span style="cursor: pointer" onclick="open_map()">Jl. Sunan Gresik IV Bahagia Kec. Babelan Kabupaten Bekasi</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card py-4 h-100">
                            <div class="card-body text-center">
                                ...
                                <hr class="my-4" />
                                <div class="small text-black-50"><span style="cursor: pointer" onclick="send_email()">raihan.febriyansah1@gmail.com</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card py-4 h-100">
                            <div class="card-body text-center">
                                ...
                                <hr class="my-4" />
                                <div class="small text-black-50"><span style="cursor: pointer" onclick="send_wa()">+62 895-1772-1586</span></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Footer-->
        <footer class="footer bg-black small text-center text-white-50"><div class="container">Copyright © <a href="https://reinkuru.github.io">Rai</a> 2022</div></footer>
        <!-- Bootstrap core JS-->
...
<script>
    function send_email() {
        window.open("https://mail.google.com/mail/?view=cm&fs=1&to=raihan.febriyansah1@gmail.com");
    }
    function send_email() {
        window.open("https://wa.me/+6289517721586");
    }
    function open_map() {
        window.open("https://goo.gl/maps/6me4LZRSkfTi4aTM9");
    }
</script>
